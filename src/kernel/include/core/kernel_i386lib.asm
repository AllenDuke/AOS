...
global park_sys_call
global unpark_sys_call
global delay_sys_call
...
unpark_sys_call:
    call save
;    mov eax, [g_unparkPid] ; 这里不用借助全局变量
    push eax                ; unparkPid
    call aos_unpark
    ret
; ======================================================================================================================
