...
struct super_block {
    ...
    u32_t	nr_inodes;	  /**< How many inodes */
    u32_t	nr_sects;	  /**< How many sectors */
    u32_t	nr_imap_sects;	  /**< How many inode-map sectors */
    u32_t	nr_smap_sects;	  /**< How many sector-map sectors */
    u32_t	n_1st_sect;	  /**< Number of the 1st data sector */
    u32_t	nr_inode_sects;   /**< How many inode sectors */
    u32_t	root_inode;       /**< Inode nr of root directory */
    u32_t	inode_size;       /**< INODE_SIZE */
    u32_t	inode_isize_off;  /**< Offset of `struct inode::i_size' */
    u32_t	inode_start_off;  /**< Offset of `struct inode::i_start_sect' */
    u32_t	dir_ent_size;     /**< DIR_ENTRY_SIZE */
    u32_t	dir_ent_inode_off;/**< Offset of `struct dir_entry::inode_nr' */
    u32_t	dir_ent_fname_off;/**< Offset of `struct dir_entry::name' */
